...
export const CATEGORIES: CategoryInfo[] = [
  { value: 'SAAS', label: 'SaaS', description: 'Software as a Service products and platforms' },
  {
    ...
    description: 'Tools and frameworks for developers',
  },
  {
    value: 'AI_ML',
  ...
  },
  {
    value: 'FINTECH',
    label: 'Fintech',
    description: 'Financial technology and banking innovation',
  },
  {
    value: 'ECOMMERCE',
    label: 'E-Commerce',
  ...
  },
  {
    value: 'SECURITY',
    label: 'Cybersecurity',
    description: 'Security tools and threat protection',
  },
];
